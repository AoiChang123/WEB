...
<body>
	...
	<!-- jquery simple tabs codepen -->
	<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>

	<script type="text/javascript">
		// Hiển thị tab đầu tiên và ẩn phần còn lại
	...
	<script>
      paypal.Buttons({
        ...
        onApprove: function(data, actions) {
          ...
          return actions.order.capture().then(function(orderData) {
            // Successful capture! For dev/demo purposes:
                ...
                window.location.replace('http://localhost/ĐACS2/index.php?quanly=camon&thanhtoan=paypal');
        ...
        onCancle:function(data){
        	 window.location.replace('http://localhost/ĐACS2/index.php?quanly=thongtinthanhtoan');
        }
