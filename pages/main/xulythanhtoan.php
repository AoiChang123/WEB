<?php
	...
	if($cart_payment == 'tienmat' || $cart_payment == 'chuyenkhoan' || $cart_payment == 'momo' || $cart_payment == 'paypal'  || $cart_payment == 'vnpay'){
	//insert vào đơn hàng
		$insert_cart = "INSERT INTO cart(id_khachhang,code_cart,cart_status,cart_date,cart_payment,cart_shipping) VALUE('".$id_khachhang."','".$code_order."',1,'".$now."','".$cart_payment."','".$id_shipping."')";
