...
<?php
	$sql_chitiet = "SELECT * FROM sanpham,danhmucsp WHERE sanpham.id_danhmuc=danhmucsp.id_danhmuc AND sanpham.id_sanpham='$_GET[id]' LIMIT 1";
...
<div class="wrapper_chitiet">
	...
	<form method="POST" action="pages/main/themgiohang.php?idsanpham=<?php echo $row_chitiet['id_sanpham'] ?>">
		<!-- <div class="chitiet_sanpham" > -->
			...
			<p style="float: left;"><input class="themgiohang" name="themgiohang" type="submit" value="Thêm giỏ hàng"></p>
	</form>
</div>
<div class="clear"></div>
<div class="tabs">
